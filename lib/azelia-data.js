...
export const azeliaPremiumPlans = [
  {
    "name": "No-Prefix",
    "price": "₹19 / month",
    "description": "Use Azelia without typing the configured prefix.",
    "scope": "User"
  },
  {
    "name": "User Premium",
    "price": "₹49 / month",
    "description": "Premium access across servers for the user, including lyrics, autoplay, premium filters and higher limits.",
    "scope": "User"
  },
  {
    "name": "Guild Premium",
    "price": "₹99 / month",
    "description": "Server-wide Premium including premium filters, custom server profile and premium music cards.",
    "scope": "Guild"
  },
  {
    "name": "Vote Premium",
    "price": "Free · 2 hours",
    "description": "Vote for Azelia on DBL to receive temporary User Premium access.",
    "scope": "User"
  }
];
