...
export const seoPagesExtra5 = {
  "azeliaLeaderboard": {
    "slug": "azeliaLeaderboard",
    "keyword": "Azelia Leaderboard",
    "title": "Azelia Leaderboard | Music Activity and Rankings",
    "description": "Explore Azelia leaderboard concepts for top users, servers, time filters and music activity statistics.",
    "intro": "Azelia Leaderboard pages should explain what a ranking means before showing a number. This page provides the public structure for top users, server activity, time windows and definitions without inventing a score when the backend does not supply one.",
    "focus": "top three, leaderboard table, time filters, user stats, server stats and metric definitions",
    "cards": [
      [
        "Top 3",
        "The first three entries can receive a visually emphasized ranking treatment when live data is available."
      ],
      [
        "Leaderboard table",
        "The full table should present the metric, period and scope."
      ],
      [
        "Time filter",
        "Daily, weekly and monthly windows separate short-term activity from longer trends."
      ],
      [
        "User stats",
        "User-level activity can include documented metrics such as songs played when telemetry exposes them."
      ],
      [
        "Server stats",
        "Guild rankings can use documented aggregate activity values."
      ],
      [
        "Definitions",
        "Every metric should explain whether it counts plays, commands, sessions or another event."
      ]
    ],
    "faq": [
      [
        "Is the leaderboard live?",
        "Only when an analytics source is configured."
      ],
      [
        "Can I see private account data?",
        "No. Public rankings should expose only intended leaderboard data."
      ],
      [
        "What does a time filter mean?",
        "It defines the measurement period used for the ranking."
      ],
      [
        "Can user and server stats be combined?",
        "They should be displayed in separate scopes so metrics stay clear."
      ]
    ],
    "related": [
      "azeliaStatus",
  ...
  "azeliaTerms": {
    "slug": "azeliaTerms",
    "keyword": "Azelia Terms of Service",
    "title": "Azelia Terms of Service",
    "description": "Read the Azelia Terms of Service covering use of the bot, dashboard, Premium features, responsibilities and restrictions.",
    "intro": "These Terms of Service describe intended rules for using Azelia's Discord bot and website. They should be finalized against the actual deployed service, payment processor and governing law before production legal use.",
    "focus": "service rules, Premium terms, user responsibilities, restrictions and effective date",
    "kind": "legal",
    "sections": [
      [
        "Acceptance of terms",
        "Using Azelia, its dashboard or related services means following applicable Discord rules, service limits and these terms. Users who do not accept the terms should stop using the service."
      ],
      [
        "Service scope",
        "Azelia provides Discord music playback, discovery, guild configuration, dashboard controls and related product features. Availability can depend on Discord, third-party music sources, hosting and the configured backend."
      ],
      [
        "User responsibilities",
        "Users are responsible for the servers they manage, the permissions they grant and the content they request or play. Users should not bypass access controls, rate limits or security checks."
      ],
      [
        "Premium terms",
        "Azelia documents Free, User Premium and Guild Premium scopes. Premium availability depends on the deployed product and external dependencies."
      ],
      [
        "Restrictions",
        "Abuse, credential theft, authorization bypass, automated abuse of public endpoints and unlawful use are prohibited."
      ],
      [
        "Changes and availability",
        "Features, pricing, integrations and documentation can change as the service evolves. Important changes should be reflected in the published terms."
      ],
      [
        "Termination",
        "Access may be restricted to protect the service, enforce these terms, respond to abuse or comply with applicable law."
      ],
      [
        "Contact",
        "Operational support should use the published support server or contact path. Legal questions should use the designated public channel."
      ]
    ],
    "faq": [
      [
        "Are these terms legal advice?",
        "No. They are a product-facing draft and should be reviewed for the actual deployment."
      ],
      [
        "Do Premium features have a guaranteed uptime?",
        "No blanket uptime guarantee is stated here."
      ],
      [
        "Can the terms change?",
        "The published document should be updated when material service changes occur."
      ],
      [
        "Where should account-specific support go?",
        "Use the official support channel and never publish tokens or passwords."
      ]
    ],
    "related": [
      "azeliaPrivacy",
  ...
  "azeliaPrivacy": {
    "slug": "azeliaPrivacy",
    "keyword": "Azelia Privacy Policy",
    "title": "Azelia Privacy Policy",
    "description": "Azelia privacy policy covering Discord authentication, dashboard data, cookies, payments, retention and user rights.",
    "intro": "This privacy page describes categories of data the Azelia dashboard architecture is designed to process. It should be reconciled with the actual deployed backend, storage providers and payment processor before final publication.",
    "focus": "data collection, Discord data, dashboard data, cookies, payments, retention and user rights",
    "kind": "legal",
    "sections": [
      [
        "Data we may receive",
        "The dashboard can receive Discord identity data needed for authentication such as Discord user ID, username, global display name and avatar information. Guild data may be processed to determine which servers a user can manage."
      ],
      [
        "Discord authentication",
        "Azelia uses Discord OAuth as the intended login mechanism. OAuth state is short-lived and sessions are signed so the browser is not trusted to invent an authenticated identity."
      ],
      [
        "Dashboard and server data",
        "Guild settings, player state and telemetry may be processed when the configured Azelia API bridge exposes those features. Exact fields depend on deployment."
      ],
      [
        "Cookies and sessions",
        "Authentication uses server-set cookies. The architecture includes a signed session cookie and short-lived OAuth state and return-path cookies."
      ],
      [
        "Payments",
        "When Premium payments are enabled, payment data should be handled through the configured payment provider. The dashboard should not store raw card credentials."
      ],
      [
        "Retention",
        "Retention should match the deployed storage layer and applicable legal requirements. This page does not invent a retention period the backend does not enforce."
      ],
      [
        "Security",
        "The architecture includes signed sessions, rate limiting, origin checks, body validation, server-side permission checks and server-only API credentials."
      ],
      [
        "User rights and contact",
        "Users should be able to ask what personal data is processed and request applicable corrections or deletion where required by law and supported by the deployment."
      ]
    ],
    "faq": [
      [
        "Does Azelia store Discord passwords?",
        "No. Discord OAuth is used instead of collecting Discord account passwords."
      ],
      [
        "Are authentication tokens stored in localStorage?",
        "The current dashboard architecture removes the localStorage authentication fallback."
      ],
      [
        "Are API keys exposed to the browser?",
        "The protected API bridge keeps its credential server-side."
      ],
      [
        "Is this policy final legal advice?",
        "No. The production version should be reviewed against the deployed data and legal requirements."
      ]
    ],
    "related": [
      "azeliaTerms",
  ...
  "azeliaRefund": {
    "slug": "azeliaRefund",
    "keyword": "Azelia Refund Policy",
    "title": "Azelia Refund Policy | Premium and Credits",
    "description": "Azelia refund policy covering Premium purchases, eligibility, payment problems, processing and support.",
    "intro": "This refund page is a product-facing policy draft for Azelia Premium. The final production policy should match the actual payment processor, billing implementation and applicable consumer law.",
    "focus": "refund rules, Premium and credits, eligibility, payment issues, processing and contact",
    "kind": "legal",
    "cards": [
      [
        "Eligibility",
        "Refund decisions should consider duplicate charges, failed entitlement delivery and payment-processing problems."
      ],
      [
        "Premium and credits",
        "The final billing implementation should define how Premium periods or credits are adjusted after approval."
      ],
      [
        "Payment issues",
        "Users should provide transaction references through the approved support channel and never post sensitive payment credentials."
      ],
      [
        "Processing",
        "Refund timing can depend on the payment processor after approval."
      ]
    ],
    "faq": [
      [
        "Are all purchases refundable?",
        "Final eligibility should follow the actual payment implementation and applicable law."
      ],
      [
        "What about duplicate charges?",
        "Duplicate or erroneous charges should be reviewed with transaction details."
      ],
      [
        "Can refunded Premium remain active?",
        "Entitlements should be reconciled with the approved refund state."
      ],
      [
        "Where do I ask for help?",
        "Use the official support channel and provide only the non-sensitive details needed to identify the payment."
      ]
    ],
    "related": [
      "premium",
  ...
  "sitemap": {
    "slug": "sitemap",
    "keyword": "Azelia Sitemap",
    "title": "Azelia Sitemap | Discord Music Bot Pages",
    "description": "Browse the Azelia website sitemap for Discord music bot features, commands, Premium, dashboard, support and legal pages.",
    "intro": "The Azelia sitemap groups the site's search-focused content so users and crawlers can discover product pages, provider guides, command references, support information and legal documents.",
    "focus": "product, features, commands, Premium, dashboard, support and legal",
    "cards": [
      [
        "Core product",
        "Discord Music Bot, Music Bot for Discord and Free Discord Music Bot explain the main product."
      ],
      [
        "Features and commands",
        "Feature and command pages cover playback, filters, queues, Premium and configuration."
      ],
      [
        "Provider guides",
        "Dedicated YouTube, Spotify, SoundCloud, Apple Music, Deezer and JioSaavn pages explain documented boundaries."
      ],
      [
        "Dashboard and status",
        "Dashboard, status and support explain operations, authentication, permissions and troubleshooting."
      ],
      [
        "Guides and comparisons",
        "Best Discord Music Bot, 2026 comparison and regional guides cover evaluation intent."
      ],
      [
        "Legal",
        "Terms, Privacy and Refund provide the public policy layer."
      ]
    ],
    "faq": [
      [
        "Does the sitemap include every page?",
        "It lists the public SEO-focused pages managed by the site configuration."
      ],
      [
        "Are all pages separate files?",
        "The Next.js app uses shared rendering with route-level pages, avoiding duplicate renderers."
      ],
      [
        "Do provider pages promise unsupported integrations?",
        "No. Provider pages distinguish documented support from unverified integrations."
      ],
      [
        "Can the sitemap be updated?",
        "Yes. Changes to the page configuration should be reflected in the route and sitemap data."
      ]
    ],
    "related": [
      "discordMusicBot",
...
export const SEO_COMMON_SECTIONS = [
  [
    "How the Azelia workflow fits together",
    "Azelia separates the Discord command surface from the audio playback layer and the source resolver. A request can begin as a prefix or slash command, move through source resolution, enter the queue and finally reach the active player. That separation lets the site explain features without pretending every source behaves identically."
  ],
  [
    "What users can expect",
    "The product model emphasizes understandable queue state, predictable server controls and a music workflow that stays useful on small and large communities. The dashboard extends that model instead of inventing a separate set of promises."
  ],
  [
    "Setup and practical use",
    "A typical setup starts with inviting the bot, granting required permissions and testing playback in a voice channel. Users can then configure guild settings, use the + prefix or available slash commands and choose Premium only when documented limits or features make it useful."
  ],
  [
    "Reliability and transparency",
    "Music depends on Discord voice connectivity, source availability, resolver behavior and Lavalink. The website therefore separates product features from external dependencies and uses status pages for operational information."
  ],
  [
    "Security and account isolation",
    "Protected dashboard actions are authorized on the server. OAuth state is validated, sessions are signed, API keys remain server-side, user routes are scoped and guild operations check management permissions."
  ],
  [
    "Azelia as a practical choice",
    "The useful combination is a real player, a source-aware resolver, a clear command surface, free and Premium filter tiers, server controls and a web layer that respects Discord authorization."
  ]
];

export const seoPageMap = Object.freeze({
  ...seoPages,
  ...seoPagesExtra1,
  ...seoPagesExtra2,
  ...seoPagesExtra3,
...
export const SEO_PAGE_ORDER_ALL = Object.keys(seoPageMap);
...
export const SEO_KEYWORDS = [
  ...
  "discord music bot playlist",
  "best free discord music bot 2025",
  "discord music bot no prefix",
  "discord music bot high quality audio",
  "discord music bot apple music",
  "discord music bot autoplay",
  "how to add music bot to discord",
  "discord music bot with dashboard",
  "discord music bot premium",
  "discord music bot equalizer",
  "discord music bot filters bass boost",
  "discord music bot like groovy",
  "discord music bot like rythm alternative",
  "best discord music bot reddit 2025",
  "discord music bot comparison",
  "discord music bot unlimited",
  "azelia discord bot",
  "azelia music bot",
  "azelia bot discord",
  "zorvex discord bot"
